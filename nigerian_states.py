NIGERIAN_STATES = {
    ...
    "Ekiti": [
        "Ado-Ekiti", "Aiyekire (Gbonyin)", "Emure", "Ekiti East", 
        "Ekiti South West", "Ekiti West", "Efon", "Ido-Osi", "Ijero", 
    ...
    "Kano": [
        ...
        "Gabasawa", "Garun Malam", "Gaya", "Gezawa", "Gwale", "Gwarzo", 
        "Kabo", "Kano Municipal", "Karaye", "Kibiya", "Kiru", "Kumbotso", 
        "Kunchi", "Kura", "Madobi", "Makoda", "Minjibir", "Nasarawa", 
        "Rano", "Rimin Gado", "Rogo", "Shanono", "Sumaila", "Takai", 
    ...
    "Niger": [
        ...
        "Magama", "Mariga", "Mashegu", "Mokwa", "Munya", "Paikoro", 
    ...
    "Ogun": [
        ...
        "Obafemi Owode", "Odogbolu", "Odeda", "Ogun Waterside", 
        "Remo North", "Shagamu"
    ],
    "Ondo": [
